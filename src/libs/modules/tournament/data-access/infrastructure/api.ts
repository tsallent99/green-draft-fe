...
export const tournamentApi = {
  getAllTournaments: async (): Promise<TournamentResponseDtoT[]> => {
    ...
    const validation = z.array(tournamentResponseDtoSchema).safeParse(response.data);
  ...
  getTournamentById: async (tournamentId: number): Promise<TournamentResponseDtoT> => {
